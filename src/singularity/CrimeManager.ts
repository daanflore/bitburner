...
export class CrimeManager {
    ...
    private SortOnKarma(this: void, first: CrimeStats, second: CrimeStats): number {
        return (second.karma / second.time) - (first.karma / first.time);
    }

    private SortOnMoneyPerSecond(this: void, first: CrimeStats, second: CrimeStats): number {
